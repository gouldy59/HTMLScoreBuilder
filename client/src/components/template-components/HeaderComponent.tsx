...
export function HeaderComponent({ component, isSelected, onSelect, onDelete }: HeaderComponentProps) {
  ...
  return (
    ...
    >
      ...
      <h1 className={`font-bold mb-2 ${
        style.fontSize === 'small' ? 'text-lg' :
        style.fontSize === 'large' ? 'text-3xl' :
        style.fontSize === 'xl' ? 'text-4xl' : 'text-2xl'
      }`}>
