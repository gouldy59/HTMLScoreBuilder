...
export function TextBlockComponent({ component, isSelected, onSelect, onUpdate, onDelete }: TextBlockComponentProps) {
    ...
    }, [content.html, content.text, isEditing]);
    ...
    return (
        <div
            className={`relative p-6 rounded-lg transition-all group ${isSelected ? 'ring-2 ring-blue-500' : 'hover:ring-2 hover:ring-blue-300'
                }`}
            style={{
